<nav class="flex items-center justify-between w-full px-5 sm:px-20 backdrop-blur-lg fixed top-0 left-0 right-0 z-50 bg-sevensoup-light shadow-md">
    ...
    <div class="relative sm:hidden">
        ...
        <ul class="absolute top-full left-0 w-full flex flex-col items-center space-y-4 bg-sevensoup-light shadow-lg p-6 transition-all transform origin-top scale-y-0 peer-checked:scale-y-100 peer-checked:opacity-100 opacity-0 sm:hidden">
