...
>
    ...
    <nav class="flex-1 px-4 py-6 space-y-2">
        <a href="/empleados" class="flex items-center py-2 px-4 rounded-lg hover:bg-green-500">
        ...
        <a href="/reservas" class="flex items-center py-2 px-4 rounded-lg hover:bg-green-500">
        ...
        <a href="/mesas" class="flex items-center py-2 px-4 rounded-lg hover:bg-green-500">
